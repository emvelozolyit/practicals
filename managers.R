...
q2_col <- c(4, 5, 5, 3, 2)
q3_col <- c(5, 2, 5, 4, 1)
q4_col <- c(5, 5, 5, NA, 2) #NA is inserted in place of the missing data
q5_col <- c(5, 5, 2, NA, 1)

#Construct a data frame using the data from all vectors 
...
#Recode AgeCat so that it is ordinal and factored
